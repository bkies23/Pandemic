...
public class ComputeMonthlyAvgTotalCases 
{
    ...
    GetResultSet grs;  // class returns MySql result set with up-to-date statisitics from Covid10 table  
    ...
    // this method uses the standard formula to check if leap year and add 29th day to February
